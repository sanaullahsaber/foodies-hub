...
const Terms = () => {
  return (
    <Container className="pt-5 mt-5">
      ...
      <p>
        Welcome to our recipe website. By using our website, you agree to comply
      ...
      <p>
        ...
        devised (including in connection with the website and our business and
        on third-party sites and services), without further notice to or consent
        from you, and without the requirement of payment to you or any other
        person or entity.
      </p>
      <p>
        By submitting any content to our website, you represent and warrant that
        you have the right to grant the license set forth in these Terms and
        Conditions, that our use of the content will not infringe on any third
        party rights, and that the content complies with our community
      ...
      <p>
        ...
        Conditions by this reference, explains how we collect, use, and disclose
        information that we receive about users of our website.
      </p>

     
        
          <Link className='text-center text-warning fw-bold' to="/register">
            <p>Go back to</p>
          </Link>
